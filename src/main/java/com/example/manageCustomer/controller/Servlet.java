...
import com.example.manageCustomer.service.CustomerServiceImpl;
...
public class Servlet extends HttpServlet {
    ...
    private void showDeleteCustomer(HttpServletRequest request, HttpServletResponse response) {
        ...
        System.out.println("Sau xoa id");
        List<Customer> customers = this.customerService.findAll();
        request.setAttribute("customers", customers);
        System.out.println("vao day chu");
